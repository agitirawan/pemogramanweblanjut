...
class Transaksi extends CI_Controller
{
    ...
    public function laporan()
    {
        ...
        $pdf->SetX(4);
        $pdf->MultiCell(19.5, 0.5, 'KIOS Tugas WEB lanjut', 0, 'L');
        $pdf->SetX(4);
        $pdf->MultiCell(19.5, 0.5, 'Telpon : 08220571922', 0, 'L');
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->SetX(4);
        $pdf->MultiCell(19.5, 0.5, 'JL. polinema ', 0, 'L');
        $pdf->SetX(4);
        $pdf->MultiCell(19.5, 0.5, ' email : TI2B@gmail.com', 0, 'L');
